        ...
        >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-[#5a4a7a] mb-2">Join Us</h1>
              <p className="text-sm text-[#8b7fa8]">Start your reading adventure today</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              {/* Name Input */}
              <div>
                <label className="block text-sm font-medium text-[#5a4a7a] mb-2">Full Name</label>
                <input
                  type="text"
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-2 bg-white/80 text-[#a89bb8]">Have an account?</span>
              </div>
            </div>
